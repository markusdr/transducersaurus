...
if __name__=="__main__":
    ...
    parser.add_argument('--ew',               help="Argument for fstminimize: encode_weights. Defaults to true.", default=False, action="store_true" )
    parser.add_argument('--el',               help="Argument for fstminimize: encode_labels. Defaults to true.", default=False, action="store_true" )
