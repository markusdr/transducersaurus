...
class Arpa2OpenFSTg2p : public Arpa2OpenFST {
	/*
	 Child class of basic Arpa2OpenFST.  Modified to build a G2P WFST model.
...
public: 
	...
	Arpa2OpenFSTg2p( ) : Arpa2OpenFST() {
		//Default constructor.
		cout << "Class ARPA2TextFST requires an input ARPA-format LM..." << endl;
	};
	
	Arpa2OpenFSTg2p ( const char* arpa_lm ) : Arpa2OpenFST( arpa_lm ) {
	...
	void make_arc_gp( string istate, string ostate, string isym, string osym, double weight ){
		//Build up an arc for the WFST.  Weights default to the Log semiring.
